...
L(P(-10, -20), P(-30,   0)),    // Left top curve
        ...
        ['M'] = new(new[]
  {
       L(P(-40,  30), P(-40, -30)),    // Left stem
        ...
        L(P(-10, -20), P(-10,  30)),    // First middle stem
       L(P(-10, -20), P( 10, -30)),  // Second hump top
     L(P( 10, -30), P( 20, -20)),    // Second hump curve
 L(P( 20, -20), P( 20,  30)),    // Second middle stem
            L(P( 20, -20), P( 35, -30)),    // Third hump top
    L(P( 35, -30), P( 45, -10)),    // Third hump curve
       L(P( 45, -10), P( 45,  30))     // Right stem
       }),
