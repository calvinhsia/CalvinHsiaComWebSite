...
public class FreeCellMove
{
    ...
    /// <summary>
    /// Returns a human-readable description of this move for display in the UI.
    /// Column/cell indexes are 0-based to match keyboard shortcuts.
    /// </summary>
    public string ToDisplayString()
    {
        ...
        return $"{cardStr}: {srcStr} → {tgtStr}{countStr}";
    }
}
