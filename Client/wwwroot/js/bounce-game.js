...
console.log('[Bounce] Canvas initialized successfully');
   ...
   console.log('[Bounce] Setting up resize listener');
    ...
    window.resizeBounceCanvas = function () {
...
clearTimeout(bounceResizeTimeout);
        ...
        // Notify Blazor of the resize with actual dimensions
    if (window.bounceComponentRef) {
 ...
 // Initial resize
   console.log('[Bounce] Running initial resize');
        window.resizeBounceCanvas();
