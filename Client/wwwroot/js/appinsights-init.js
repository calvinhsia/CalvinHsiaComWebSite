// Application Insights Initialization - v3
console.log('[AppInsights v3] Loading from external JS file...');

// Connection string 
const connectionString = "InstrumentationKey=9fa4f886-5da4-48d9-ab3b-a2f82bddc5ae;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/;LiveEndpoint=https://westus2.livediagnostics.monitor.azure.com/;ApplicationId=11c467be-c34b-4158-a2ff-1308c196bd54";

if (!connectionString) {
    console.log('?? [AppInsights v3] Connection string not configured');
    // Create stub appInsights object so calls don't fail
    window.appInsights = {
        trackEvent: function () { console.log('stub trackEvent'); },
        trackTrace: function () { console.log('stub trackTrace'); },
        trackException: function () { console.log('stub trackException'); },
        trackPageView: function () { console.log('stub trackPageView'); },
        trackMetric: function () { console.log('stub trackMetric'); }
    };
} else {
    console.log('? [AppInsights v3] Connection string configured - initializing SDK...');

    // Application Insights SDK snippet (Microsoft official)
    !function (T, l, y) {
        var S = T.location,
            k = "script",
        ...
        var n = T[t] || function (d) {
            ...
            function v(e, t) {
                ...
                return n[E + "id"] = a[b](), n[E + "type"] = a, n["ai.operation.name"] = S && S.pathname || "_unknown_", n["ai.internal.sdkVersion"] = "javascript:snippet_" + (m.sv || m.version), {
                    ...
                    }(), iKey: e, name: "Microsoft.ApplicationInsights." + e.replace(/-/g, "") + "." + t, sampleRate: 100, tags: n, data: { baseData: { ver: 2 } }
                }
            } var h = d.url || y.src;
            if (h) {
                function a(e) {
        ...
        // CRITICAL FIX: Explicitly set window.appInsights for C# interop
        window.appInsights = n;
        console.log('? [AppInsights v3] SDK object created and assigned to window.appInsights');
    }(window, document, {
...
console.log('[AppInsights v3] Initialization complete - typeof appInsights:', typeof window.appInsights);
